...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'products_product', (
            ...
            ('money_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 4, 0, 0))),
        ))
    ...
    models = {
        ...
        u'products.product': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 0, 0)'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'money_type': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
